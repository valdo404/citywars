...
# DRIVER_MEMORY="512M"
#EXECUTOR_MEMORY="10GB"  # Increased executor memory for sorting operations
...
spark-submit \
  ...
  --packages io.github.valdo404:osm4scala-spark3_2.12:1.0.11,io.github.valdo404:osm4scala-core_2.12:1.0.11 \
